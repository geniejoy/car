...
export class GraphQLServer {
  ...
  constructor(props: Props) {
    const defaultOptions: Options = {
      ...
      endpoint: '/gql',
      subscriptionsEndpoint: '/gqlsub',
      playgroundEndpoint: '/gqlplay',
    ...
    this.subscriptionServer = undefined;
  ...
  start(callback: (() => void) = () => undefined): Promise<void> {
    ...
    if (!disablePlayground) {
      ...
      const playgroundOptions = { endpoint: endpoint, subscriptionsEndpoint };
        ...
        this.subscriptionServer = SubscriptionServer.create(
          {
            ...
            execute,
            subscribe,
            onOperation: (message: any, connection: any, webSocket: any) => {
              return {
                ...connection,
                context: typeof this.context === 'function' ? this.context({ connection }) : this.context
              };
            }
          },
          {
